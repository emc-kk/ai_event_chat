...
# - category: "iso9001" 等のテンプレートはカテゴリ付きプリセット（将来的にカテゴリ選択で表示）
# Usage: rails runner db/seeds/manual_templates.rb
...
puts "Upserted #{PRESET_TEMPLATES.size} preset templates."
